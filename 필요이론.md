...
ex) width: 50px; margin: 20px; padding: 10px; border: 1px;<br>
=> 50 + 20x2 + 10x2 + 1x2 = 112px<br>
여기서 만약 `box-sizing: border-box;` 라고 설정할 경우에는 padding값과 border값을 포함하지 않기 때문에  **width(height) = margin** 으로 적용됨<br>
ex) width: 50px; margin: 20px; padding: 10px; border: 1px;<br>
=> 50 + 20x2 = 90px<br>
<br><br>
